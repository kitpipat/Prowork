...
<?php if ($aQuoItemsList['nTotalRes'] > 0) { ?>
	...
	?>
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
			<img src="<?= base_url('application/assets/images/products/NoImage.png') ?>">
		</div>
		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<input class="text-right" type="text" style="width:100%" value="<?= $nQty ?>" data-seq="<?= $nItemSeq ?>" data-unitpri="<?= $nPdtUnitPri ?>" onkeypress="return FSxQUOEditItemQty(event,this)">
				</div>
			</div>
		</div>
	<?php } ?>
