...
<script>
	...
	$('.xCNConfirmCreatePO').click(function(e) {
		...
		if(aItem.length != 0){
			$.ajax({
				...
				success	: function (tResult) {
					...
					var tDocumentNumber = oResult.tReturnDocument;
					$('#odvContentModalCreatePO').html('สร้างเอกสารใบสั่งซื้อสำเร็จ สามารถตรวจสอบ และอนุมัติเอกสารของคุณได้ที่หน้าจอใบสั่งซื้อ' + '<br>' + 'หมายเลขเอกสารใบสั่งซืัอ : ' + tDocumentNumber);
					...
					// $('#odvModalCreatePO .xCNConfirmCreatePO').click(function(e) {
					// 	setTimeout(function(){
					// 		JSxCallPagePIListMain();
					// 	}, 500);
					// });
