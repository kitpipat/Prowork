		...
		<nav>
			<ul class="xCNPagenation pagination justify-content-end">
				...
				<li class="page-item <?=$tDisabledLeft;?>">
					<a class="page-link" aria-label="Previous" onclick="JSvModalType_ClickPage('Fisrt')"><span aria-hidden="true">&laquo;</span></a>
				</li>
				<li class="page-item <?=$tDisabledLeft;?>">
					<a class="page-link" aria-label="Previous" onclick="JSvModalType_ClickPage('previous')"><span aria-hidden="true">&lsaquo;</span></a>
				</li>
				...
				<li class="page-item <?=$tDisabledRight?>">
					<a class="page-link" aria-label="Next" onclick="JSvModalType_ClickPage('next')"><span aria-hidden="true">&rsaquo;</span></a>
				</li>
				<li class="page-item <?=$tDisabledRight?>">
					<a class="page-link" aria-label="Next" onclick="JSvModalType_ClickPage('Last')"><span aria-hidden="true">&raquo;</span></a>
				</li>
			</ul>
		</nav>
    </div>
	...
	function JSvModalType_ClickPage(ptPage) {
		...
		switch (ptPage) {
			...
			case 'Last': //กดหน้าสุดท้าย
				nPageCurrent 	= '<?=$aModalProductList['rnAllPage']?>';
			break;
			default:
				nPageCurrent = ptPage
		}
