...
<div class="container-fulid">
	...
	<!--Section บน-->
	<div class="row">
		<div class="col-lg-6 col-md-6"><span class="xCNHeadMenu">ขนาดสินค้า</span></div>
		<div class="col-lg-6 col-md-6 <?=$tPer_create?>"><button class="xCNButtonInsert pull-right" onClick="JSwSizeProductCallPageInsert('insert','')">+</button></div>
	</div>
	...
	<div class="card" style="margin-top: 10px;">
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div id="odvContent_SizeProduct" class="xCNContent"></div>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function JSwLoadTableList(pnPage){
		$.ajax({
			...
			success	: function (tResult) {
				$('#odvContent_SizeProduct').html(tResult);
			},
	...
	function JSwSizeProductCallPageInsert(ptType,ptCode){
		$.ajax({
			type	: "POST",
			url		: "r_sizeproductcallpageInsertorEdit",
			data 	: {
						'tTypepage'  : ptType,
						'tCode'	 	 : ptCode
					  },
	...
	function JSxCallPageSizeProductMain(){
		$.ajax({
			type	: "POST",
			url		: "r_sizeproduct",
			cache	: false,
