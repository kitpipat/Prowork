...
<div class="container-fulid">
	...
	<!--Section บน-->
	<div class="row">
		<div class="col-lg-6 col-md-6"><span class="xCNHeadMenu">กลุ่มสินค้า</span></div>
		<div class="col-lg-6 col-md-6 <?=$tPer_create?>"><button class="xCNButtonInsert pull-right" onClick="JSwGroupProductCallPageInsert('insert','')">+</button></div>
	</div>
	...
	<div class="card" style="margin-top: 10px;">
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div id="odvContent_GroupProduct" class="xCNContent"></div>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function JSwLoadTableList(pnPage){
		$.ajax({
			...
			success	: function (tResult) {
				...
				$('#odvContent_GroupProduct').html(tResult);
			},
	...
	function JSwGroupProductCallPageInsert(ptType,ptCode){
		JSxModalProgress('open');
		$.ajax({
			type	: "POST",
			url		: "r_groupproductcallpageInsertorEdit",
			data 	: {
						'tTypepage'  : ptType,
						'tCode'	 	 : ptCode
					  },
	...
	function JSxCallPageGroupProductMain(){
		JSxModalProgress('open');
		$.ajax({
			type	: "POST",
			url		: "r_groupproduct",
