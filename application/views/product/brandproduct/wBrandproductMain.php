...
<div class="container-fulid">
	...
	<!--Section บน-->
	<div class="row">
		<div class="col-lg-6 col-md-6"><span class="xCNHeadMenu">ยี่ห้อสินค้า</span></div>
		<div class="col-lg-6 col-md-6 <?=$tPer_create?>"><button class="xCNButtonInsert pull-right" onClick="JSwBrandProductCallPageInsert('insert','')">+</button></div>
	</div>
	...
	<div class="card" style="margin-top: 10px;">
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<div id="odvContent_BrandProduct" class="xCNContent"></div>
				</div>
			</div>
		</div>
	</div>
...
<script>
	...
	function JSwLoadTableList(pnPage){
		$.ajax({
			...
			success	: function (tResult) {
				$('#odvContent_BrandProduct').html(tResult);
			},
	...
	function JSwBrandProductCallPageInsert(ptType,ptCode){
		$.ajax({
			type	: "POST",
			url		: "r_brandproductcallpageInsertorEdit",
			data 	: {
						'tTypepage'  : ptType,
						'tCode'	 	 : ptCode
					  },
	...
	function JSxCallPageBrandProductMain(){
		$.ajax({
			type	: "POST",
			url		: "r_brandproduct",
			cache	: false,
