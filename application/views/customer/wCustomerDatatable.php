		...
		<nav>
			<ul class="xCNPagenation pagination justify-content-end">
				...
				<li class="page-item <?=$tDisabledLeft;?>">
					<a class="page-link" aria-label="Previous" onclick="JSvCustomer_ClickPage('Fisrt')"><span aria-hidden="true">&laquo;</span></a>
				</li>

				<li class="page-item <?=$tDisabledLeft;?>">
					<a class="page-link" aria-label="Previous" onclick="JSvCustomer_ClickPage('previous')"><span aria-hidden="true">&lsaquo;</span></a>
				</li>
				...
				<li class="page-item <?=$tDisabledRight?>">
					<a class="page-link" aria-label="Next" onclick="JSvCustomer_ClickPage('next')"><span aria-hidden="true">&rsaquo;</span></a>
				</li>

				<li class="page-item <?=$tDisabledRight?>">
					<a class="page-link" aria-label="Next" onclick="JSvCustomer_ClickPage('Last')"><span aria-hidden="true">&raquo;</span></a>
				</li>
			</ul>
		</nav>
    </div>
	...
	function JSvCustomer_ClickPage(ptPage) {
		...
		switch (ptPage) {
			...
			case 'Last': //กดหน้าสุดท้าย
				nPageCurrent 	= '<?=$aCustomerList['rnAllPage']?>';
			break;
			default:
				nPageCurrent = ptPage
		}
